...
<nav class="navbar container">
    ...
    <div class="navbar__nav">         
      <ul class="navbar__menu">
        ...
        <li class="navbar__item"><a href="Flights.html" class="navbar__link">Flights</a></li>
...
<?php
	if(isset($_POST['submitbutton'])){
		...
		{	
			if ($i==$iterations){
				$names.=$arr[$i]["first_name"]." ".$arr[$i]["last_name"];	
			}
			else{
				$names.=$arr[$i]["first_name"]." ".$arr[$i]["last_name"].", ";
			}
...
/*email part*/
		...
		<html>
			<head>
				<img src='https://w7.pngwing.com/pngs/871/583/png-transparent-airplane-font-awesome-airplane-angle-hand-airplane-thumbnail.png' width='300 height='300' alt='airplane'>
				<h2 style='margin-left:70px'> WINGS </h2><br>
		...
		<div class='center'>
			<div class='content'>
				...
				<div class='line'></div>
				<hr>
				<p1 style='color:yellow'>The ticket has been mailed to you at $email_to</p1>
			</div>
		</div>";
...
/*Database entry part*/
	...
	$sql = "UPDATE flights SET $class =$class-$iterations	 where Dep_Date='$Ddate' and Flight_No='$airpno'";
